...
main()
{
     ...
     float thirdFarenheightConversion, thirdKelvinConversion, thirdRankineConversion;

     thirdFarenheightConversion = (thirdTemp - 491.67) * 5 / 9;
     thirdKelvinConversion = ((9 / 5) * thirdFarenheightConversion) + 32;
     thirdRankineConversion = thirdKelvinConversion + 459.67;
